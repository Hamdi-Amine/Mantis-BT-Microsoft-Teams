...
<?php echo form_security_field( 'plugin_MicrosoftTeams_config' ) ?>
...
<table class="table table-bordered table-condensed table-striped">
    ...
    <tr>
      ...
      <td colspan="2">
        <p>
          Specifies the mapping between Mantis project names and MicrosoftTeams webhooks.
        </p>
        <p>
          Option name is <strong>plugin_MicrosoftTeams_url_webhooks</strong> and is an array of 'Mantis project name' => 'MicrosoftTeams webhook'.
    ...
    <tr>
      ...
      <td colspan="2">
        <p>
          Specifies the mapping between Mantis project names and MicrosoftTeams #channels.
        </p>
        <p>
          Option name is <strong>plugin_MicrosoftTeams_channels</strong> and is an array of 'Mantis project name' => 'MicrosoftTeams channel name'.
          Array options must be set using the <a href="adm_config_report.php">Configuration Report</a> screen.
    ...
    <tr>
      ...
      <td colspan="2">
        <p>
          Specifies the bug fields that should be attached to the MicrosoftTeams notifications.
        </p>
        <p>
          Option name is <strong>plugin_MicrosoftTeams_columns</strong> and is an array of bug column names.
          Array options must be set using the <a href="adm_config_report.php">Configuration Report</a> screen.
          <?php
    ...
    <tr>
      ...
      <td colspan="2">
        <p>
          Specifies the mapping between Mantis and MicrosoftTeams user names.
        </p>
        <p>
          Option name is <strong>plugin_MicrosoftTeams_usernames</strong> and is an array of 'Mantis user name' => 'MicrosoftTeams user name'.
          Array options must be set using the <a href="adm_config_report.php">Configuration Report</a> screen.
